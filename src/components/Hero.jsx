    ...
    md:flex-row flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        rounded-[10px] mb-2'>
          ...
          <span classNakme='text-white'>1 Month</span> Account
          </p>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          ...
          <div className='ss:flex hidden md:mr-4 mr-o'>
            <GetStarted />
          </div>
        </div>
           ...
           ss:text-[68px] text-[52px]
            text-white ss:leading-[100px]
             ...
             <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
              ...
              the credit cards most likely to fit your needs. We examine
              annual percentage rates, annual fees. </p>
      </div>
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt='billing' className='w-[100%]
        h-[100%] relative z-[5] '/>
